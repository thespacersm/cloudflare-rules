...
#### Sync / API - Motive Commerce Search
Chiamate API REST di sincronizzazione catalogo da Motive Commerce Search (IndexRetriever).
```text
http.request.uri.path contains "/rest/" and starts_with(http.user_agent, "Motive/1.0 IndexRetriever")
```

#### Sync / Bridge - eMagicOne Store Manager
Chiamate di sincronizzazione catalogo e ordini dell'applicativo desktop eMagicOne Store Manager tramite script bridge.
```text
http.request.uri.path contains "bridge_" and http.user_agent contains "Chrome/107.0.0.0"
```
...
#### Satispay - Callback & Webhook di Pagamento
Notifiche webhook, callback e chiamate API inviate dai server di Satispay.
```text
...
| **Sync / API** | `http.request.uri.path contains "/rest/" and starts_with(http.user_agent, "Motive/1.0 IndexRetriever")` | Connettore REST Motive Commerce Search |
| **Sync / Bridge** | `http.request.uri.path contains "bridge_" and http.user_agent contains "Chrome/107.0.0.0"` | Connettore Bridge eMagicOne Store Manager |
