...
#### Sync / Media - Connettore TitanpicsSync
Chiamate API REST del connettore TitanpicsSync per la sincronizzazione di immagini e media catalogo.
```text
http.request.uri.path contains "/rest" and http.user_agent contains "TitanpicsSync"
```
...
| **Sync / API** | `http.request.uri.path contains "/rest" and http.user_agent contains "TitanpicsSync"` | Connettore REST TitanpicsSync |
