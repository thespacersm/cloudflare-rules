...
Blocca bot, crawler non autorizzati e script che eseguono query di ricerca gravose su Magento 1 (catalogsearch) o combinazioni di filtri layered navigation senza passare dalla normale navigazione del sito.
```text
